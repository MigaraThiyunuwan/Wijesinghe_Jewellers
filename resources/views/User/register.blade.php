  ...
  <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
    ...
    <div class="flex flex-wrap">
        ...
        <div style="width: 100%; display:flex; justify-content:center; margin-top: 20px">
            <div class="">
                <div class="p-2 bg-blue-800 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex"
                    role="alert">

                    <span class="font-semibold mr-2 text-left flex-auto">Already have an account?</span>
                    <a href="{{ asset('user/login') }}">
                        <span
                            class="flex rounded-full bg-indigo-500 uppercase px-2 py-1 text-xs font-bold mr-3">LOGIN</span>
                    </a>
            ...
            <div class="bg-yellow-100 border border-blue-400 text-yellow-700 px-4 py-3 rounded relative"
                role="alert">
