                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                  ...
                  <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3 text-sm">
                      @if ($order->status == 'pending')
                      <button class="px-3 py-2 text-xs font-medium text-center text-white bg-yellow-700 rounded-lg hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 ">Pending</button>
                      @endif
              ...
              <table class="w-full">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                  ...
                  <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3 text-sm">
                      <button data-modal-target="timeline-modal{{ $order->id}}" data-modal-toggle="timeline-modal{{ $order->id}}"  type="button" class="px-3 py-2 text-xs font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 ">Status</button>
                                ...
                                <div class="p-4 md:p-5">
                                  ...
                                  @if ($order->status == 'accept')
                                      <ol  class="relative border-s border-gray-200  ms-3.5 mb-4 md:mb-5">                  
                                        <li style="opacity: 0.5" class="mb-10 ms-8">            
                                            ...
                                            <h3 style="justify-content: space-between" class="flex items-start mb-1 text-lg font-semibold text-gray-900 ">DESIGNING
                                        
                                            <span class="bg-yellow-100 text-yellow-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded  ms-3">Pending</span>
                                            </h3>
                                          
                                            <time class="block mb-3 text-sm font-normal leading-none text-gray-500 ">Discover the artistry of hand-drawn jewelry designs</time>
                                        ...
                                        <li style="opacity: 0.5" class="mb-10 ms-8">            
                                          ...
                                          <h3 style="justify-content: space-between"  class="flex items-start mb-1 text-lg font-semibold text-gray-900 ">CAD DESIGNING
                                            <span class="bg-yellow-100 text-yellow-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded  ms-3">Pending</span>
                                          </h3>
                                        
                                          <time class="block mb-3 text-sm font-normal leading-none text-gray-500 ">With CAD technology, Transform your ideas into flawless design</time>
                                        ...
                                        <li style="opacity: 0.5" class="mb-10 ms-8">            
                                          ...
                                          <h3 style="justify-content: space-between"  class="flex items-start mb-1 text-lg font-semibold text-gray-900 ">WAXING 
                                            <span class="bg-yellow-100 text-yellow-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded  ms-3">Pending</span>
                                          </h3>
                                        
                                          <time class="block mb-3 text-sm font-normal leading-none text-gray-500 ">Art of shaping intricate designs in wax, a crucial step before casting.</time>
                                        ...
                                        <li style="opacity: 0.5" class="mb-10 ms-8">            
                                          ...
                                          <h3 style="justify-content: space-between"  class="flex items-start mb-1 text-lg font-semibold text-gray-900 ">CASTING 
                                            <span class="bg-yellow-100 text-yellow-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded  ms-3">Pending</span>
                                          </h3>
                                        
                                          <time class="block mb-3 text-sm font-normal leading-none text-gray-500 ">Casting process melds these precious metals seamlessly.</time>
                                        ...
                                        <li style="opacity: 0.5" class="mb-10 ms-8">            
                                          ...
                                          <h3 style="justify-content: space-between"  class="flex items-start mb-1 text-lg font-semibold text-gray-900 ">SOLDERING 
                                            <span class="bg-yellow-100 text-yellow-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded  ms-3">Pending</span>
                                          </h3>
                                        
                                          <time class="block mb-3 text-sm font-normal leading-none text-gray-500 ">Soldering process brings together individual parts.</time>
                                        ...
                                        <li style="opacity: 0.5" class="mb-10 ms-8">            
                                          ...
                                          <h3 style="justify-content: space-between"  class="flex items-start mb-1 text-lg font-semibold text-gray-900 ">GEM SOURCING AND SORTING 
                                            <span class="bg-yellow-100 text-yellow-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded  ms-3">Pending</span>
                                          </h3>
                                        
                                          <time class="block mb-3 text-sm font-normal leading-none text-gray-500 ">We meticulously select and categorize gemstones.</time>
                                        ...
                                        <li style="opacity: 0.5" class="mb-10 ms-8">            
                                          ...
                                          <h3 style="justify-content: space-between"  class="flex items-start mb-1 text-lg font-semibold text-gray-900 ">STONE SETTING
                                            <span class="bg-yellow-100 text-yellow-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded  ms-3">Pending</span>
                                          </h3>
                                        
                                          <time class="block mb-3 text-sm font-normal leading-none text-gray-500 ">Our skilled craftsmen place each stone, ensuring durability.</time>
                                        ...
                                        <li style="opacity: 0.5" class="mb-10 ms-8">            
                                          ...
                                          <h3 style="justify-content: space-between"  class="flex items-start mb-1 text-lg font-semibold text-gray-900 ">POLISHING 
                                            <span class="bg-yellow-100 text-yellow-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded  ms-3">Pending</span>
                                          </h3>
                                        
                                          <time class="block mb-3 text-sm font-normal leading-none text-gray-500 ">Wijesinghe Jewelry employs cutting-edge tools and unmatched attention to detail in our polishing process.</time>
                                        ...
                                        <li style="opacity: 0.5" class="mb-10 ms-8">            
                                          ...
                                          <h3 style="justify-content: space-between"  class="flex items-start mb-1 text-lg font-semibold text-gray-900 ">QUALITY CONTROL 
                                          {{-- <span class="bg-green-100 text-green-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded  ms-3">Done</span> --}}
                                          <span class="bg-yellow-100 text-yellow-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded  ms-3">Pending</span>
                                          </h3>
                                        
                                          <time class="block mb-3 text-sm font-normal leading-none text-gray-500 ">We meticulously check each piece after every step of the process.</time>
