    ...
    <main class="profile-page">
                ...
                <div class="flex flex-wrap justify-center">
                  ...
                  <div class="w-full lg:w-4/12 px-4 lg:order-3 lg:text-right lg:self-center">
                    <div class="py-6 px-3 mt-32 sm:mt-0">
                      <a href="{{ route('user.customize') }}"> <button class="bg-yellow-500 active:bg-pink-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150" type="button">
                        Customize Jewellery
                      </button>
                    </a>
                    <a href="{{ route('user.mycustomize') }}"> <button class="bg-yellow-500 active:bg-pink-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150" type="button">
                      My Customizations
                    </button>
                  </a>
        ...
        <div class="container mb-4">
          ...
          <div style="justify-content: space-between; display: flex">
            ...
            <a href="{{ route('user.directorders') }}"> <button class="bg-blue-500 active:bg-pink-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150" type="button">
              See All orders
            </button>
          </a>
          </div>
