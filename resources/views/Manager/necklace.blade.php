              ...
              <table class="w-full">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                  ...
                  class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3 text-sm">{{$necklace->price}} &nbsp;&nbsp; <button> <i class="fa-solid fa-pen-to-square"></i> </button> </td>
                    
                    <td  class="px-4 py-3 text-sm">{{$necklace->quantity}} &nbsp;&nbsp; <button> <i class="fa-solid fa-pen-to-square"></i> </button> </td>
